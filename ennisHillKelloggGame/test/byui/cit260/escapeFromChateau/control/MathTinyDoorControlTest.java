...
public class MathTinyDoorControlTest {
    ...
    public void testCalcFuelFills() {
        ...
        double result = instance.calcFuelFills(minutesPerOunce, fuelCapacity, burnTime);
        ...
        minutesPerOunce = -20.0;
        fuelCapacity = 24.0;
        burnTime = 16.0;
        expResult = -1.0; //Expected output return value

        //call function to run test
        result = instance.calcFuelFills(minutesPerOunce, fuelCapacity, burnTime);
